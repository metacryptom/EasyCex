    ...
    futures(): any {
      return {
        ...
        async getBook(
          ...
          return get(
            `/api/futures/v3/instruments/${instrument_id}/book${params ? `?${querystring.stringify(params)}` : ''}`,
          )
        },
        ...
        async getTrades(
          ...
          return get(
            `/api/futures/v3/instruments/${instrument_id}/trades${params ? `?${querystring.stringify(params)}` : ''}`,
          )
        },
        async getCandles(
          instrument_id: string,
          ...
          return get(
            `/api/futures/v3/instruments/${instrument_id}/candles${params ? `?${querystring.stringify(params)}` : ''}`,
          )
        },
    ...
    swap(): any {
      return {
        ...
        async getTrades(
          ...
          return get(
            `/api/swap/v3/instruments/${instrument_id}/trades${params ? `?${querystring.stringify(params)}` : ''}`,
          )
        },
        async getCandles(
          instrument_id: string,
          ...
          return get(
            `/api/swap/v3/instruments/${instrument_id}/candles${params ? `?${querystring.stringify(params)}` : ''}`,
          )
        },
        async getIndex(instrument_id: string): Promise<any> {
